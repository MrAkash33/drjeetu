      ...
      <div class="col-12 col-md-8 col-lg-6">
       <div class="d-flex flex-column justify-content-center h-100">
        ...
        <p class="about-sub-heading my-2">
         Dr.Jeetu Sanchez is a highly skilled and compassionate physician with over 4 years of experience in internal medicine. She obtained her medical degree from Harvard Medical School, where she graduated with honors, showcasing her dedication to academic excellence.
        </p>
        <p class="about-sub-heading my-2">
