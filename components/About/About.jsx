     ...
     <div class="row">
      <div class="col-12 col-md-8 col-lg-6">
       <div class="d-flex flex-column justify-content-center h-100">
        <h2 class="about-heading">About Dr.Jeetu</h2>
        <p class="about-sub-heading my-2">
         I am Jeetu Nayak, a committed and skilled healthcare professional with a robust background in both pharmacy and physiotherapy. With four years of experience as a Doctor of Pharmacy, I have dedicated my career to improving patient outcomes through a blend of medical expertise and compassionate care. My academic journey began at Bhuvneswar University in Odisha, where I earned my doctorate in pharmacy. This rigorous program equipped me with a deep understanding of pharmaceuticals, including their effects, interactions, and proper usage, which is crucial in providing effective patient care.
        </p>
        <p class="about-sub-heading my-2">
